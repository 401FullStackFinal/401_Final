...
let toy = Object.values(pets).map
...
toyRoute.post('/toys', (request, response) => {
  let petResponse = {_id: uuid(), name: request.body.name, favorite_toy: request.body.favorite_toy};
  pets[petResponse.name] = petResponse;
